#!/bin/bash
# script name : shub.bash
# script args : $1 -- comments for git
#       	$2 -- remove interactivity if parameter equals "noprompting"
#
...
heroku git:remote -a development-quilombola-com -r production-heroku
